 ...
 * @author
 */
public class ComboAutoComplete extends PlainDocument {
    ...
    public ComboAutoComplete(final JComboBox comboBox) {
        ...
        hidePopupOnFocusLoss = false;//System.getProperty("java.version").startsWith("1.5");
    ...
    public static void enable(JComboBox comboBox) {
        ...
        new ComboAutoComplete(comboBox);
    }
